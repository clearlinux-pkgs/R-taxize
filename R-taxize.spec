...
Version  : 0.10.0
Release  : 65
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/taxize_0.10.0.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/taxize_0.10.0.tar.gz
...
%setup -q -n taxize
pushd ..
cp -a taxize buildavx2
popd
pushd ..
cp -a taxize buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738972523
...
/usr/lib64/R/library/taxize/tests/fixtures/class2tree_classification_dup_high_level.yml
...
/usr/lib64/R/library/taxize/tests/fixtures/classification_lowest_common_itis.yml
/usr/lib64/R/library/taxize/tests/fixtures/classification_lowest_common_ncbi.yml
...
/usr/lib64/R/library/taxize/tests/fixtures/get_pow_accepted_no_results.yml
...
/usr/lib64/R/library/taxize/tests/fixtures/gna_data_sources.yml
/usr/lib64/R/library/taxize/tests/fixtures/gna_parse.yml
/usr/lib64/R/library/taxize/tests/fixtures/gna_search.yml
/usr/lib64/R/library/taxize/tests/fixtures/gni_details.yml
/usr/lib64/R/library/taxize/tests/fixtures/gni_parse.yml
/usr/lib64/R/library/taxize/tests/fixtures/gni_parse_not_parsed.yml
...
/usr/lib64/R/library/taxize/tests/testthat/test-gna_data_sources.R
/usr/lib64/R/library/taxize/tests/testthat/test-gna_details.R
/usr/lib64/R/library/taxize/tests/testthat/test-gna_parse.R
/usr/lib64/R/library/taxize/tests/testthat/test-gna_search.R
...
/usr/lib64/R/library/taxize/tests/testthat/test-ncbi_rate_limit_pause.R
...
/usr/lib64/R/library/taxize/tests/testthat/test-taxize_options.R
