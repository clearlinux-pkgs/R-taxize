...
Source0  : https://cran.r-project.org/src/contrib/taxize_0.9.91.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573830132
...
/usr/lib64/R/library/taxize/tests/fixtures/col_search_older_checklist_xml.yml
